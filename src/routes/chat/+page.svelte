    ...
    <svelte:head>
        ...
        <!-- magnific-popup css -->
        <link href="https://webui-lyart.vercel.app/css/magnific-popup.css" rel="stylesheet" type="text/css" />
        <link href="https://cdn.jsdelivr.net/npm/remixicon@2.3.0/fonts/remixicon.css" rel="stylesheet">


        <!-- owl.carousel css -->
        <link rel="stylesheet" href="https://webui-lyart.vercel.app/css/owl.carousel.min.css">

        <link rel="stylesheet" href="https://webui-lyart.vercel.app/css/owl.theme.default.min.css">
        

        <!-- Bootstrap Css -->
        <link href="https://webui-lyart.vercel.app/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="https://webui-lyart.vercel.app/css/icons.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="https://webui-lyart.vercel.app/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />

 <script src="https://webui-lyart.vercel.app/js/jquery.min.js"></script>
        <script src="https://webui-lyart.vercel.app/js/bootstrap.bundle.min.js"></script>
        <script src="https://webui-lyart.vercel.app/js/simplebar.min.js"></script>
        <script src="https://webui-lyart.vercel.app/js/waves.min.js"></script>

        <!-- Magnific Popup-->
        <script src="https://webui-lyart.vercel.app/js/jquery.magnific-popup.min.js"></script>

        <!-- owl.carousel js -->
        <script src="https://webui-lyart.vercel.app/js/owl.carousel.min.js"></script>

        <!-- page init -->
        <script src="https://webui-lyart.vercel.app/js/index.init.js"></script>

        <script src="https://webui-lyart.vercel.app/js/app.js"></script>
                    ...
                    <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
                        ...
                        <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-1.jpg" alt="" class="profile-user rounded-circle">
                            </a>
                            ...
                            <div class="px-4 pb-4" dir="ltr">
                                ...
                                <div class="owl-carousel owl-theme" id="user-status-carousel">
                                    <div class="item">
                                        <a href="#" class="user-status-box">
                                            <div class="avatar-xs mx-auto d-block chat-user-img online">
                                                <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-2.jpg" alt="user-img" class="img-fluid rounded-circle">
                                    ...
                                    <div class="item">
                                        <a href="#" class="user-status-box">
                                            <div class="avatar-xs mx-auto d-block chat-user-img online">
                                                <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-4.jpg" alt="user-img" class="img-fluid rounded-circle">
                                                <span class="user-status"></span>
                                            </div>
                                    ...
                                    <div class="item">
                                        <a href="#" class="user-status-box">
                                            <div class="avatar-xs mx-auto d-block chat-user-img online">
                                                <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-5.jpg" alt="user-img" class="img-fluid rounded-circle">
                                                <span class="user-status"></span>
                                            </div>
                                    ...
                                    <div class="item">
                                        <a href="#" class="user-status-box">
                                            <div class="avatar-xs mx-auto d-block chat-user-img online">
                                                <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-6.jpg" alt="user-img" class="img-fluid rounded-circle">
                                                <span class="user-status"></span>
                                            </div>
                                    ...
                                    <ul class="list-unstyled chat-list chat-user-list">
                                            ...
                                            <a href="#">
                                                <div class="d-flex">
                                                    <div class="chat-user-img away align-self-center me-3 ms-0">
                                                        <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-3.jpg" class="rounded-circle avatar-xs" alt="">
                                                        <span class="user-status"></span>
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <li class="active">
                                            <a href="#">
                                                <div class="d-flex">
                                                    <div class="chat-user-img online align-self-center me-3 ms-0">
                                                        <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt="">
                                                        <span class="user-status"></span>
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <li>
                                            <a href="#">                        
                                                <div class="d-flex">
                                                    <div class="chat-user-img away align-self-center me-3 ms-0">
                                                        <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-6.jpg" class="rounded-circle avatar-xs" alt="">
                                                        <span class="user-status"></span>
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="d-flex">
                                                    <div class="chat-user-img away align-self-center me-3 ms-0">
                                                        <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-7.jpg" class="rounded-circle avatar-xs" alt="">
                                                        <span class="user-status"></span>
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="d-flex">
                                                    <div class="chat-user-img away align-self-center me-3 ms-0">
                                                        <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-8.jpg" class="rounded-circle avatar-xs" alt="">
                                                        <span class="user-status"></span>
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
            ...
            <div class="user-chat w-100 overflow-hidden">
                <div class="d-lg-flex">
                        ...
                        <div class="chat-conversation p-3 p-lg-4" data-simplebar="init">
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <div class="conversation-list">
                                        <div class="chat-avatar">
                                            <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-4.jpg" alt="">
                                        </div>
                                ...
                                <li class="right">
                                    <div class="conversation-list">
                                        <div class="chat-avatar">
                                            <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-1.jpg" alt="">
                                        </div>
                                                        ...
                                                        <li class="list-inline-item message-img-list">
                                                            <div>
                                                                <a class="popup-img d-inline-block m-1" href="assets/images/small/img-2.jpg" title="Project 2">
                                                                    <img src="https://themesbrand.com/chatvia/layouts/assets/images/small/img-2.jpg" alt="" class="rounded border">
                                                                </a>
                                                            </div>
                                                            <div class="message-img-link">
                                                                <ul class="list-inline mb-0">
                    ...
                    <div class="user-profile-sidebar">
                        ...
                        <div class="text-center p-4 border-bottom">
                            <div class="mb-4">
                                <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-4.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="">
                            </div>
